...
- [X] 크리스마스 디데이 할인 혜택을 받을 수 있는지 확인한다.
    - [X] 이벤트 기간(2023.12.01~2023.12.25)에 해당되는지 확인한다.
...
- [X] 금액은 아래와 같은 형식으로 출력한다.
    - [X] [형식] 1000단위 마다 콤마를 찍는다.
    - [X] [형식] 맨 뒤에 '원'을 붙인다.
